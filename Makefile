...
all: test_add test_cartpole benchmark analyze_solution test_sequence test_maze test_taxi
...
clean:
	rm -f test_add test_cartpole benchmark analyze_solution test_sequence test_maze test_taxi *.o
